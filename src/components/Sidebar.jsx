...
const Sidebar = () => {
  return (
    <aside class="flex flex-col items-center bg-green-700 shadow-xl w-16 h-full fixed z-10 top-0">

    <ul>
        <li class="transition-colors hover:bg-green-600">
        <a
            href=""
            class="h-16 px-5 flex flex justify-center items-center w-full transition-colors fill-white hover:fill-white focus:fill-green-300"
        >
