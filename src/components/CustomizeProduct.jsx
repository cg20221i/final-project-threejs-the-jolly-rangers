  ...
  return (
      <section id="CustomizeProduct" className="flex h-screen pl-10 font-['Helvetica']">
        <div className="my-auto justify-end">
          ...
          <div className="grid grid-cols-3 gap-4 h-[50vh] w-[50rem]">
            <button className="relative bg-white rounded h-64 transition ease-out duration-150 hover:shadow-xl hover:-translate-y-2 p-0 hover:ring hover:ring-green-100 active:-translate-y-1 active:shadow-lg">
             <img src="https://via.placeholder.com/400x400.png" alt="Design" className="object-cover h-full w-full rounded transition"/>
             <div className="rounded absolute bottom-0 w-full bg-gradient-to-t from-gray-500/50 py-3 px-4">
            ...
            <button className="relative bg-white rounded h-64 transition ease-out duration-150 hover:shadow-xl hover:-translate-y-2 p-0 hover:ring hover:ring-green-100 active:-translate-y-1 active:shadow-lg">
             <img src="https://via.placeholder.com/400x400.png" alt="Design" className="object-cover h-full w-full rounded transition"/>
             <div className="absolute bottom-0 w-full bg-gradient-to-t from-gray-500/50 py-3 px-4">
